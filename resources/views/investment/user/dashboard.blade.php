...
<div class="nk-content-body">
    <div class="nk-block-head">
        <div class="nk-block-head-sub"><span>{{ __('Leasing') }}</span></div>
        <div class="nk-block-between-md g-4">
            <div class="nk-block-head-content">
                <h2 class="nk-block-title fw-normal">{{ __('My Devices') }}</h2>
                <div class="nk-block-des">
                    <p>{{ __('Instantly view the production of your bitcoin mining devices.') }}</p>
                </div>
            </div>
            <div class="nk-block-head-content">
                <ul class="nk-block-tools gx-3">
                   <!-- <li class="order-md-last"><a href="{{ route('user.investment.invest') }}" class="btn btn-primary"><span>{{ __('Invest') }}</span> <em class="icon ni ni-arrow-long-right"></em></a></li>
                    --> <li><a href="{{ route('deposit') }}" class="btn btn-light btn-white"><span>{{ __('Deposit') }}</span> <em class="icon ni ni-arrow-long-right"></em></a></li>
                    ...
                    <div class="card-inner">
                        <div class="nk-wgacc">
                            <div class="nk-wgacc-title text-base">
                                {{ __("Miner Account") }} 
                                <em class="icon ni ni-info fs-13px text-soft nk-tooltip" title="{{ __("The available balance in your miner account.") }}"></em>
                            </div>
                            <div class="nk-wgacc-group flex-lg-nowrap gx-4">
                                <div class="nk-wgacc-sub">
                                   ...
                                   <!-- <div class="nk-wgacc-subtitle">{{ __('Trasfer from pool') }}</div>-->
                                </div>
                                <div class="nk-wgacc-sub">
                                    ...
                                    <div class="nk-wgacc-subtitle">{{ __('In the pool') }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="card-action">
                            <ul class="nk-block-tools gx-1">
                                <li><a href="{{ route('user.investment.payout') }}" class="btn btn-secondary iv-payout"><span>{{ __('Transfer from pool') }}</span> <em class="icon ni ni-arrow-long-right"></em></a></li>
    ...
    <div class="nk-block nk-block-lg">
        <div class="nk-block-head-sm">
            <div class="nk-block-head-content">
                <h5 class="nk-block-title">{{ __('Active Device') }} <span class="count text-base">({{ count($activePlans) }})</span></h5>
            </div>
        </div>
