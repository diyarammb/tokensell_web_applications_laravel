    ...
    <div class="modal-content">
        ...
        <div class="modal-body modal-body-md">
			...
			<div class="nk-modal-title">
				...
				<p class="caption-text">{!! __("You can transfer miner account balance to main account.") !!}</p>
			</div>
			<div class="nk-block">
			        ...
			        <div class="row gy-3">
			        	<div class="col-sm-12">
			        		<div class="form-group">
			                    ...
			                    <div class="form-note">
			                    	{{ __("Pending or pool amount is not included in available funds.") }}
			                    </div>
			                </div>
			        	</div>
			            <div class="col-sm-12">
			        ...
			        <div class="notes mb-n2">
			            <ul>
			                <li class="alert-note is-plain text-primary">
			                    ...
			                    <p>{{ __("The amount will immediately transfer into your main account so you can withdraw funds or re-rental.") }}</p>
			                </li>
			            </ul>
			        </div>
			    </form>
			...
			<div class="nk-modal modal-body-sm text-center">
               ...
               <img src="https://minersocial.com/images/bitcoin.svg" alt="Flowers in Chania" width="100" height="100">
                <h4 class="nk-modal-title title">{{ __("Oops, insufficient balance") }}</h4>
                <div class="nk-modal-text">
                    <p class="caption-text">{{ __("This amount in your Production account is trasferred yo your Miner account.") }}</p>
                </div>
