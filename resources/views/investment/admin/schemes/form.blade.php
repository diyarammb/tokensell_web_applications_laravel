...
<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body modal-body-md">
            ...
            <form name="invest" modal_invest_id="{{ $modal_invest_id }}" action="{{ $form_action }}" class="form-validate is-alter"{!! ($type!='new') ? ' data-confirm="update"' : '' !!}>
                <div class="row gy-2">
                    <div class="col-md-8">
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-md-12">
                        <div class="form-group dropzone-section">
                            ...
                            @else
                                ...
                                @else   
                                    <div class="dz-preview dz-processing dz-image-preview dz-complete">
                                        <div class="dz-image">
                                            <img width="200" height="200" src="/images/invest-img/{{$scheme->image}}" />
                                        </div>
                                        <a class="remove-doc" href="#" id="init-drop"> Remove</a>
                                    </div>
                                @endif
                            @endif
                        </div>
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label" for="term-duration">{{ __('Last 24 Hours') }}</label>
                            <div class="row gy-2">
                                <div class="col-6">
                                    <input type="text" name="lasttimeandday" class="form-control" id="term-lasttimeandday" value="{{ data_get($scheme, 'lasttimeandday') }}" required {{$restrict}}>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label" for="term-duration">{{ __('Last 28 d|Days') }}</label>
                            <div class="row gy-2">
                                <div class="col-6">
                                    <input type="text" name="lastdays" class="form-control" id="term-lastdays" value="{{ data_get($scheme, 'lastdays') }}" required {{$restrict}}>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label" for="term-duration">{{ __('TH/s') }}</label>
                            <div class="row gy-2">
                                <div class="col-6">
                                    <input type="text" name="ths" class="form-control" id="term-ths" value="{{ data_get($scheme, 'ths') }}" required {{$restrict}}>
                                </div>
