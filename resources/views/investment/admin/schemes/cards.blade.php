...
@if(!blank($schemes))
    ...
    <div class="col-lg-4 col-sm-6">
        <div class="card card-bordered plan-card">
            ...
            <img width="200" height="200" class="card-img-top" src="/images/invest-img/{{$scheme->image}}"  alt="{{ data_get($scheme, 'name') }}">
            @else
                <img class="card-img-top" src="/images/invest-img/place-holder.png"  alt="{{ data_get($scheme, 'name') }}">
            @endif            
