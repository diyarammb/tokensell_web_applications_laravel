                ...
                <div class="nk-block-head-content">
                    <ul class="nk-block-tools g-3">
                        ...
                        <li class="nk-block-tools-opt">
                            <div class="btn-group">
                                <button class="uaj-mntnx btn btn-primary" data-action="manual" data-view="any" data-backdrop="static"><em class="icon ni ni-plus"></em> <span>{{ __("Add") }}</span></button>
                                <div class="btn-group dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-smd dropdown-menu-right">
                                        <ul class="link-list-opt no-bdr">
                                            ...
                                            <li><a href="javascript:void(0)" class="uaj-mntnx" data-action="manual" data-backdrop="static" data-view="profit">
                                                <em class="icon ni ni-wallet-in"></em><span>{{ __('Add Profit') }}</span></a>
                                            </li>
                                            <li><a href="javascript:void(0)" class="uaj-mntnx" data-action="manual" data-backdrop="static" data-view="loss">
                                                <em class="icon ni ni-wallet-saving"></em><span>{{ __('Add Loss') }}</span></a>
                                            </li>
                                            <li><a href="javascript:void(0)" class="uaj-mntnx" data-action="manual" data-backdrop="static" data-view="penalty">
...
<script type="text/javascript">
    const updateSetting = "{{ route('admin.profile.update') }}", 
          routes = { profit: "{{ route('admin.investment.process.profits') }}", plan: "{{ route('admin.investment.process.plans') }}", transfer: "{{ route('admin.investment.process.transfers') }}", manual: "{{route('admin.investment.manual.add')}}" };
          msgs = {
              addnew:{ 
