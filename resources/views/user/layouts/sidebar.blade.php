                ...
                <div class="nk-sidebar-widget d-none d-xl-block">
                    <div class="user-account-info between-center">
                        <div class="user-account-main">
                            ...
                            <h6 class="overline-title-alt">{{"Miner ACCOUNT BALANCE" }}</h6>
                    ...
                    <ul class="nk-menu">
                        ...
                        <li class="nk-menu-item{{ is_route('dashboard') ? ' active' : '' }}">
                            <a href="{{route('dashboard')}}" class="nk-menu-link">
                                <span class="nk-menu-icon"><img src="https://cdn-icons-png.flaticon.com/512/898/898554.png" class="imgss"></span>
                                <span class="nk-menu-text">{{ __('Pool Information') }}</span>
                            </a>
                        </li>
                        <li class="nk-menu-item{{ is_route('transaction.list') ? ' active' : '' }}">
                            <a href="{{ route('transaction.list') }}" class="nk-menu-link">
                                <span class="nk-menu-icon"><img src="https://cdn-icons-png.flaticon.com/512/1131/1131868.png" class="imgss"></span>
                        ...
                        <li class="nk-menu-item{{ (is_route('user.investment.dashboard') || is_route('user.investment.details') || is_route('user.investment.history') || is_route('user.investment.transactions') || is_route('user.invest.*')) ? ' active' : '' }}">
                            <a href="{{ route('user.investment.dashboard') }}" class="nk-menu-link">
                                <span class="nk-menu-icon"><img src="https://cdn-icons-png.flaticon.com/512/1181/1181075.png" class="imgss"></span>
                                <span class="nk-menu-text">{{ __('My Devices') }}</span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="nk-menu-item{{ (is_route('user.investment.plans')) ? ' active' : '' }}">
                            <a href="{{ route('user.investment.plans') }}" class="nk-menu-link">
                                <span class="nk-menu-icon"><img src="https://cdn-icons-png.flaticon.com/512/1181/1181134.png" class="imgss"></span>
                                <span class="nk-menu-text">{{ __('New Devices') }}</span>
                            </a>
                        </li>
                        @endif
                        <li class="nk-menu-item{{ is_route('account.*') ? ' active' : '' }}">
                            <a href="{{ route('account.profile') }}" class="nk-menu-link">
                                <span class="nk-menu-icon"><img src="https://cdn-icons-png.flaticon.com/512/947/947933.png" class="imgss"></span>
                                <span class="nk-menu-text">{{ __('My Miner Profile') }}</span>
                            </a>
                        </li>
                        @if (referral_system())
                        <li class="nk-menu-item{{ is_route('referrals') ? ' active' : '' }}">
                            <a href="{{ route('referrals') }}" class="nk-menu-link">
                                <span class="nk-menu-icon"><img src="https://cdn-icons-png.flaticon.com/512/1039/1039720.png" class="imgss"></span>
                                <span class="nk-menu-text">{{ __('Block Rewards') }}</span>
                            </a>
                        </li>
                        @endif
