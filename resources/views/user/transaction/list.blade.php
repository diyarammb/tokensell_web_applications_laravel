...
@section('content')
    <div class="nk-content-body">
        <div class="nk-block-head">
            <div class="nk-block-head-sub"><span>{{ __('Miner Statement') }}</span></div>
            <div class="nk-block-between-sm g-4">
                <div class="nk-block-head-content">
                    <h2 class="nk-block-title fw-normal">{{ __('Lease History') }}</h2>
                    <div class="nk-block-des">
                        <p>{{ __('View all the details of your mining account.') }}</p>
                    </div>
                </div>
