    ...
    <div class="nk-refwg-invite{{ $card_class }}"{{ $card_id }}>
        <div class="nk-refwg-head g-3">
            <div class="nk-refwg-title">
              <!--  <h5 class="title">{{ __(sys_settings('referral_invite_title', 'More Bitcoin?')) }}</h5>-->
              <h5 class="title">{{'More Bitcoin?' }}</h5>
                ...
                <div class="title-sub">{{'Invite your friends with your special link and benefir from generous Bitcoin block rewards.' }}</div>
                @endif
            </div>
        ...
        <div class="nk-refwg-url">
            <div class="form-control-wrap">
                ...
                <input type="text" class="form-control copy-text" id="ref-url" value="{{ route('auth.invite', ['ref' => get_ref_code(auth()->user()->id)]) }}">
            </div>
        </div>
    </div>
