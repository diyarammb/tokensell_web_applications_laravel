...
<div class="nk-tb-col nk-tb-col-tools">
    <ul class="nk-tb-actions gx-2">
        ...
        <li class="nk-tb-action-hidden">
            <a href="javascript:void(0)" class="btn btn-sm btn-trigger btn-icon uaj-tnx btn-tooltip" data-action="view" data-view="tnx" 
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <ul class="link-list-opt no-bdr">
                        <li><a href="javascript:void(0)" class="uaj-tnx" data-action="view" data-view="tnx" data-uid="{{ the_hash($transaction->id) }}"><em class="icon ni ni-eye"></em><span>{{ __('View Details') }}</span></a></li>
                        <li><a href="javascript:void(0)" class="uaj-tnx" data-action="view" data-view="profile" data-uid="{{ the_hash($transaction->id) }}"><em class="icon ni ni-user-alt"></em><span>{{ __('User Profile') }}</span></a></li>
