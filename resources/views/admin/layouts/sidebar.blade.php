        ...
        <div class="nk-sidebar-content">
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item has-sub{{ is_route('admin.csmCustomizationAll') || is_route('admin.csmCustomizationUpdate') || is_route('admin.csmCustomizationNew') ? ' active' : '' }}">
                        <a href="javascript:void(0)" class="nk-menu-link nk-menu-toggle">
                            <span class="nk-menu-icon"><em class="icon ni ni-b-si"></em></span>
                            <span class="nk-menu-text">{{ __('Front panel') }}</span>
                        </a>
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item{{ is_route('admin.csmCustomizationNew') ? ' active' : '' }}">
                                <a href="{{ route('admin.csmCustomizationNew') }}" class="nk-menu-link"><span class="nk-menu-text">{{ __('Add New') }}</span></a>
                            </li>
                            <li class="nk-menu-item{{ is_route('admin.csmCustomizationAll') || is_route('admin.csmCustomizationUpdate') ? ' active' : '' }}">
                                <a href="{{ route('admin.csmCustomizationAll') }}" class="nk-menu-link"><span class="nk-menu-text">{{ __('All List') }}</span></a>
                            </li>
                        </ul>
                    </li>
