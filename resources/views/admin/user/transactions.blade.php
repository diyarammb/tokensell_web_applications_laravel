        ...
        @forelse($user->transactions as $tnx)
            <div class="nk-tb-item">
                ...
                <div class="nk-tb-col nk-tb-col-tools tnx-details">
                    <a href="javascript:void(0)" class="btn btn-sm btn-icon btn-trigger mr-n1 uaj-tnx" data-action="view" data-view="tnx" data-uid="{{ the_hash($tnx->id) }}"><em class="icon ni ni-chevron-right"></em></a>
                </div>
            </div>
        @empty
            <div class="nk-tb-item">
