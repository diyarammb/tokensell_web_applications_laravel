                                ...
                                <ul class="btn-group gx-4">
                                    ...
                                    <li class="align-center ml-2">
                                        <div class="custom-control custom-control-sm custom-switch">
                                            <input type="checkbox" class="custom-control-input qaj-dwm" data-slug="{{ data_get($method, 'slug') }}" data-action="payment" id="pm-{{ Str::slug(data_get($method, 'name')) }}"{{ (data_get($methodDetail, data_get($method, 'slug').'.status') == 'active') ? ' checked': '' }}>
