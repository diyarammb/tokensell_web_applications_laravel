...
Route::get('user-dashboard/customization/new', 'AdminDashboardController@csmCustomizationNew')->name('csmCustomizationNew');
Route::get('user-dashboard/customization/all', 'AdminDashboardController@csmCustomizationAll')->name('csmCustomizationAll');
Route::get('user-dashboard/customization/update/{id}', 'AdminDashboardController@csmCustomizationUpdate')->name('csmCustomizationUpdate');
Route::post('user-dashboard/customization/new', 'AdminDashboardController@csmCustomizationNewManage')->name('csmCustomizationNewP');
Route::post('user-dashboard/customization/update', 'AdminDashboardController@csmCustomizationUpdateManage')->name('csmCustomizationUpdateP');
Route::delete('user-dashboard/customization/delete/{id}', 'AdminDashboardController@csmCustomizationDeleteManage')->name('csmCustomizationDeleteP');
...
Route::get('users/group/show', 'UserController@showGroups')->name('users.group.show');
Route::get('users/group/new', 'UserController@addNewGroup')->name('users.group.new');
Route::get('users/group/show-assign', 'UserController@showAssignGroup')->name('users.group.show.assign');

Route::post('users/group/save', 'UserController@saveGroup')->name('users.group.save');
Route::post('users/group/assign', 'UserController@userAssignGroup')->name('users.group.assign');
